...
for nfp in nfp_arr:
    ...
    for count, point in enumerate(idx_nonan_delta_ae):
        ...
        if count == 0:
            ...
            ax3.plot(a_mesh[idx], b_mesh[idx], 'rx', alpha = 0.6, markersize = 4, label = "QA")

        ax3.plot(a_mesh[idx], b_mesh[idx], 'rx', alpha = 0.6, markersize = 4)
    ...
    for count, point in enumerate(idx_nonan_delta_ae):
        ...
        if count == 0:
            ...
            ax3.plot(a_mesh[idx], b_mesh[idx], 'go', alpha = 0.6, markersize = 4, label = "QH")

        ax3.plot(a_mesh[idx], b_mesh[idx], 'go', alpha = 0.6, markersize = 4)
